      ...
      <div className={styles.container}>
        ...
        <div className={styles.contenedorSecciones}>
          <section className={styles.contenedoresQuienesSomos}>
            ...
            <p>
              <span>Inelar, una empresa de más de 50 años especializada en
              los Sistemas automatizados de detección y extinción de incendios</span>. Con
          ...
          <section className={styles.contenedoresQuienesSomos}>
            ...
            <p>
              ...
              transforma en un servicio de protección, por lo que <span>complementamos
          ...
          <section className={styles.contenedoresQuienesSomos}>
            ...
            <p>
              Podemos exhibir hoy, como resultado de nuestro esfuerzo, una <span>extensa gama de productos y servicios de alta calidad</span> que nos han convertido en un símbolo de tecnología e innovación, líder en el mercado argentino.
            </p>
          </section>
          <section className={styles.contenedoresQuienesSomos}>
