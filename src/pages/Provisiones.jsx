    ...
    <Layout>
      ...
      <div className={styles.contenedorPosicionamientoContenidoServicio}>
        <div className={styles.contenedorTextoServicio}>
          <p className={styles.textoServicios}>En Inelar, sabemos que el éxito de cualquier proyecto depende de los recursos adecuados. Ofrecemos provisiones tecnológicas de primera calidad para garantizar que tengas todo lo que necesitas para llevar a cabo tu proyecto con éxito.</p>
