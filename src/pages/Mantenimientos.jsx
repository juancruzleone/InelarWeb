    ...
    <Layout className={styles.app}>
      ...
      <div className={styles.contenedorPosicionamientoContenidoServicio}>
        <div className={styles.contenedorTextoServicio}>
          <p className={styles.textoServicios}>Inelar presta servicios de mantenimientos a todos los clientes que lo deseen. Contamos con equipo de última tecnología para llevar a cabo los mantenimientos y un equipo de técnicos especializados para su realización.</p>
